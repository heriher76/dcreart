	...
	<!-- Default box -->
      <div class="box">
        <div class="box-header with-border">
          <h3 class="box-title">@yield('title') Admin</h3>
          <div class="box-tools pull-right">
          <button data-url="{{route('admin.accounts.admin.create')}}" data-title="Buat Kategori" class="btn btn-success btn-xs btn-show-modal" data-toggle="modal" data-target="#myModal">
...
$('#datatables').DataTable({
    ...
    serverSide: true,
    order: [[3, 'DESC']],
    ajax: "{{route('admin.accounts.admin.data')}}",
    columns: [
        {data: "DT_RowIndex"},
        {data: "name"},
        {data: "email"},
