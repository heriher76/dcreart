...
<head>
  ...
  <link rel="shortcut icon" type="image/x-icon" href="{{asset('/')}}assets/images/logo-dcreartdesign.png" />
  <!-- Bootstrap 3.3.6 -->
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <span>Admin - {{env('APP_NAME')}} - @yield('title')</span>
      </h1>
      <ol class="breadcrumb">
  ...
  <footer class="main-footer">
    ...
    <strong>&copy; {{env('APP_NAME')}}</strong> {{Carbon\Carbon::now()->format('Y')}}
  </footer>
